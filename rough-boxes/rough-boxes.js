...
registerPaint('rough-boxes', class {
  ...
  paint(ctx, geom, props) {
    ...
    rect.roughness = props.get('--rough-roughness').toString();
    rect.fillStyle = 'solid';
    rect.fill = props.get('--rough-fill').toString();
    rect.stroke = props.get('--rough-stroke').toString();
    rect.strokeWidth = parseInt(props.get('--rough-stroke-width').toString());
